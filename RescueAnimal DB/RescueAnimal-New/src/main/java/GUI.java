...
public class GUI implements ActionListener {
    ...
    private boolean validateDogInfo() {
        ArrayList<String> dogList = db.readNames("Dog");
        // Makes sure the same name is not found in the database
        for(String name: dogList) {
            if(name.equalsIgnoreCase(dogTextFields.get("Name").getText())) {
        ...
        if (dogTextFields.get("Name").getText().isEmpty() || dogTextFields.get("Breed").getText().isEmpty() ||
                dogTextFields.get("Acquisition Date").getText().isEmpty() ||
                dogTextFields.get("Acquisition Country").getText().isEmpty() ||
                dogTextFields.get("Service Country").getText().isEmpty()) {
            createPopup("One or more fields are empty.");
            return false;
        }
        return true;
    }
    ...
    private boolean validateMonkeyInfo() {
        ArrayList<String> monkeyList = db.readNames("Monkey");
        for(String name: monkeyList) {
            if (name.equalsIgnoreCase(monkeyTextFields.get("Name").getText())) {
        ...
        // Makes sure none of the text fields are empty
        if (monkeyTextFields.get("Name").getText().isEmpty() ||
                monkeyTextFields.get("Acquisition Date").getText().isEmpty() ||
                monkeyTextFields.get("Acquisition Country").getText().isEmpty() ||
                monkeyTextFields.get("Service Country").getText().isEmpty()) {
            createPopup("One or more fields are empty.");
            return false;
        }
        return true;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Creates a comma separated list of the dog names
            ...
            for(Object name:db.readNames("Dog")) {
            ...
            for(Object name:db.readNames("Monkey")) {
                list.append(name.toString());
                list.append(" ");
            }
            createPopup(list.toString());
        ...
        // Displays the names of all animals that are not reserved and are in service
            ...
            for(Object name:db.readNames("Available")) {
                list.append(name.toString());
                list.append(" ");
            }
            createPopup(list.toString());
        ...
        // Create a dog object and store it if input is valid
            ...
            if (validateDogInfo()) {
                ...
                // Adds the dog to the database and displays a confirmation
                db.createDog(name, breed, gender, age, weight, acquisitionDate, acquisitionCountry, trainingStatus,
        ...
        // Create a monkey object and store it if input is valid
            ...
            if (validateMonkeyInfo()) {
                ...
                db.createMonkey(name, species, gender, age, weight, tailLength, height, bodyLength,
            ...
            createPopup(db.reserveAnimal(animalType, reserveCountry));
        }
    }
}
